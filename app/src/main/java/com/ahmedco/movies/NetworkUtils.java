...
public class NetworkUtils {
    ...
    public static URL buildSearchUrl(String TMDBSearchQuery) {
        Uri builtUri = Uri.parse(TMDB_SEARCH_BASE_URL).buildUpon().appendQueryParameter(PARAM_QUERY, TMDBSearchQuery).appendQueryParameter(PARAM_API_KEY, VALUE_API_KEY).appendQueryParameter(PARAM_LANGUAGE, getLanguage()).build();
        URL url = null;
        try {
